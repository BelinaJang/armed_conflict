...
Final data: From Tables 1-4, we can see that all four mortality rates seemed to decrease over the years and that countries with armed conflict appeared to have higher rates compared to countries without armed conflict. From Table 5, we can see that countries with armed conflicts have higher total death counts compared to countries without armed conflicts. Table 5 shows a clearer distinction between the two groups.

Filtered data: I excluded the three countries with the highest total death counts for each year and then repeated the same process for Tables 1-5. Tables 6-10 don’t seem very different from Tables 1-5.
