...
table1( ~ gdp1000_group + OECD + urban | armed_conflict, data = data_2000,overall=c(Right="Total"), caption=caption, footnote=footnote)
```
...
mat_data_wide <- mat_data %>% pivot_wider(names_from = Year, values_from = matMor) %>% rename(X2000 = `2000`, X2017 = `2017`)
